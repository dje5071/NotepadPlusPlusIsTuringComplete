...
The tape is a line beginning with a ! followed by a string of 0s and 1s.
...
A movement instruction of 0 (left) will replace the first 0 on the tape with two 0s:
!00001000
[   ^
